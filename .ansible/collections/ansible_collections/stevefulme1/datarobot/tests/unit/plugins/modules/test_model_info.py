"""Unit tests for stevefulme1.datarobot.model_info module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.datarobot.plugins.modules.model_info"
CLIENT_PATH = "ansible_collections.stevefulme1.datarobot.plugins.module_utils.api_client"


class TestInfo:
    """Test model_info info retrieval."""

    @patch(f"{CLIENT_PATH}.requests")
    def test_list_models(self, mock_requests, module_args):
        """Listing models returns items."""
