...
"""Ansible module to query DataRobot model resources."""
...
---
module: model_info
short_description: List or retrieve DataRobot models
description:
    - Retrieve information about DataRobot model resources.
version_added: "1.0.0"
author:
...
- name: List all models
  stevefulme1.datarobot.model_info:
...
def main():
    ...
    if not params.get("project_id"):
        module.fail_json(msg="project_id is required to list models")
