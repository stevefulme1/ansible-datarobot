...
def find_resource(client, params):
    ...
    try:
        result = client.get("/api/v1/feature_lists")
...
def create_resource(client, params):
    ...
    return client.post("/api/v1/feature_lists", data=payload)
...
def update_resource(client, existing, params):
    ...
    return client.put(f"/api/v1/feature_lists/{resource_id}", data=payload)


def delete_resource(client, existing):
    """Delete a resource."""
    resource_id = existing.get("id", existing.get("feature_list_id", ""))
    client.delete(f"/api/v1/feature_lists/{resource_id}")
