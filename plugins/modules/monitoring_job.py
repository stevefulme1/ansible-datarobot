...
def create_resource(client, params):
    ...
    return client.post("/api/v1/monitoring_jobs", data=payload)
...
def update_resource(client, existing, params):
    ...
    return client.put(f"/api/v1/monitoring_jobs/{resource_id}", data=payload)


def delete_resource(client, existing):
    """Delete a resource."""
    resource_id = existing.get("id", existing.get("monitoring_job_id", ""))
    client.delete(f"/api/v1/monitoring_jobs/{resource_id}")
