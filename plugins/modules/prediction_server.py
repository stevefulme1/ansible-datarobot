...
def find_resource(client, params):
    ...
    try:
        result = client.get("/api/v1/prediction_servers")
...
def create_resource(client, params):
    ...
    return client.post("/api/v1/prediction_servers", data=payload)
...
def update_resource(client, existing, params):
    ...
    return client.put(f"/api/v1/prediction_servers/{resource_id}", data=payload)


def delete_resource(client, existing):
    """Delete a resource."""
    resource_id = existing.get("id", existing.get("prediction_server_id", ""))
    client.delete(f"/api/v1/prediction_servers/{resource_id}")
